...
<head>
    ...
    <title>Cập nhật thông tin món</title>
...
<body>
    <div class="container">
        ...
        <div class="mb-3">
                ...
                <input type="text" class="form-control" id="matailieu" name="matailieu" value="<?= $patient->getId() ?>" placeholder="Điền tên tài liệu" required>
            </div>
            <div class="mb-3">
                <label for="tentailieu" class="form-label">Tên món</label>
                <input type="text" class="form-control" id="tentailieu" name="tentailieu" value="<?= $patient->getten(); ?>"
                    required>
            </div>
